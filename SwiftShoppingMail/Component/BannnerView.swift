...
protocol BannerViewDataSource: AnyObject {  //数据源
    func numberOfBanners(_ bannerView: BannnerView) -> Int
    func viewForBanner(_ bannerView: BannnerView, index: Int,
                       convertView: UIView?) -> UIView
}

protocol BannerViewDelegate: AnyObject {   //响应事件
    func didSelectBanner(_ bannerView: BannnerView, index: Int)
}

class BannnerView: UIView, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func SetUpViews() {
        ...
        collectionView.register(UICollectionViewCell.self,forCellWithReuseIdentifier: BannnerView.cellId)
    ...
    func collectionView(_ collectionView: UICollectionView,
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: BannnerView.cellId, for: indexPath)
        ...
        if let view = cell.contentView.viewWithTag(BannnerView.convertViewTag) {
            ...
            newView.tag = BannnerView.convertViewTag
    ...
    func scrollViewDidEndScrollingAnimation(_ scrollView: UIScrollView) {
        ...
        let current = Int(collectionView.contentOffset.x / collectionView.frame.width)
        if current > total + 1 {
